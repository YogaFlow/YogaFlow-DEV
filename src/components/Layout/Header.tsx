    ...
    <header className="sticky top-0 z-30 bg-surface/95 backdrop-blur supports-[backdrop-filter]:bg-surface/85 border-b border-border px-4 py-3 sm:px-6 sm:py-4 max-[380px]:px-3 max-[380px]:py-2.5">
      <div className="flex items-center justify-between">
        <div className="flex items-center min-w-0">
          <button
            onClick={onMenuClick}
            className="lg:hidden p-3 rounded-sm hover:bg-surfaceSunken mr-3 sm:mr-4 shrink-0 max-[380px]:p-2.5 max-[380px]:mr-2"
          >
        ...
        <div className="flex items-center space-x-3 sm:space-x-4 shrink-0 max-[380px]:space-x-2">
          <div className="relative">
            ...
            >
              <span className="relative inline-flex items-center justify-center">
                ...
                {unreadCount > 0 && (
                  <span
                    aria-hidden
                    className="absolute -top-0.5 -right-1 flex h-[14px] min-w-[14px] items-center justify-center rounded-full bg-danger px-[3px] text-[10px] font-bold leading-none text-onBrand tabular-nums ring-1 ring-surface max-[380px]:-top-0 max-[380px]:-right-0.5"
                  >
            ...
            <div
              ...
              className={`absolute right-0 top-full mt-2 w-[min(22rem,calc(100vw-1.5rem))] max-[380px]:w-[min(18rem,calc(100vw-1rem))] bg-surface border border-border rounded-md shadow-lg p-4 z-40 origin-top-right transition-all duration-200 ease-out ${
                isNotificationsOpen
