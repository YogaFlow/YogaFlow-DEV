    ...
    <div className="flex shrink-0 items-center gap-3 px-4 py-3 border-b border-border bg-surface">
      {showBackButton && (
        <button
          type="button"
          onClick={onBack}
          className="p-2 -ml-1 rounded-sm hover:bg-surfaceSunken text-textMuted transition-colors lg:hidden"
      ...
      {onDeleteRequest && (
        <div className="relative shrink-0" ref={menuRef}>
          <button
            ...
            className="p-2 rounded-sm text-textMuted hover:bg-surfaceSunken hover:text-textMuted transition-colors"
          ...
          {menuOpen && (
            <div
              role="menu"
              className="absolute right-0 top-full mt-1 z-50 min-w-[11rem] rounded-md border border-border bg-surface py-1 shadow-lg"
            >
              <button
                type="button"
                role="menuitem"
