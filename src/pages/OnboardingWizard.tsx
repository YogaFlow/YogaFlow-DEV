...
const OnboardingWizard: React.FC = () => {
  ...
  if (success || successPending) {
    return (
      <div className="min-h-screen bg-sand flex items-center justify-center p-4">
        <div className="bg-surface rounded-md border border-border p-3.5 max-w-md w-full text-center">
  ...
  if (user) {
    return (
      <div className="min-h-screen bg-sand flex items-center justify-center p-4">
        <div className="bg-surface rounded-md border border-border p-3.5 max-w-md w-full text-center">
          <div className="w-16 h-16 bg-accentSoft rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <div className="bg-surface rounded-md border border-border p-3.5">
          ...
          {step === 2 && (
            <div>
              ...
              <div className="flex items-stretch border border-border rounded-sm overflow-hidden focus-within:ring-2 focus-within:ring-brand">
                <input
                  type="text"
                  value={slug}
                  onChange={e => {
          ...
          {step === 5 && (
            <div>
              <div className="bg-surfaceSunken rounded-md border border-border p-3.5 mb-6 space-y-2 text-sm">
                {[
              ...
              {submitError && (
                <div className="mt-4 p-3 bg-dangerSoft border border-danger rounded-sm text-sm text-danger">
                  {submitError}
                </div>
              )}
            </div>
        ...
        <div className="flex justify-between mt-6">
          ...
          {step < STEPS.length ? (
            <button
              ...
              disabled={!canAdvance()}
              className="flex items-center gap-1.5 bg-brand text-onBrand px-6 py-2.5 rounded-sm hover:bg-brandPressed transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Weiter
